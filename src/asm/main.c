...
/* i8to? */
int8_t sx_int8_int8 (int8_t a, int msb)
{
  if (msb == 0)
    return (int8_t) a;
  else
...
int16_t sx_int8_int16 (int8_t a, int msb)
{
  if (msb == 0)
    return (int16_t) a;
  else
...
int32_t sx_int8_int32 (int8_t a, int msb)
{
  if (msb == 0)
    return (int32_t) a;
  else
...
int64_t sx_int8_int64 (int8_t a, int msb)
{
  if (msb == 0)
    return (int64_t) a;
  else
...
/* i16to? */
int16_t sx_int16_int16 (int16_t a, int msb)
{
  if (msb == 0)
    return (int16_t) a;
  else
...
int32_t sx_int16_int32 (int16_t a, int msb)
{
  if (msb == 0)
    return (int32_t) a;
  else
...
int64_t sx_int16_int64 (int16_t a, int msb)
{
  if (msb == 0)
    return (int64_t) a;
  else
...
/* i32to? */
int32_t sx_int32_int32 (int32_t a, int msb)
{
  if (msb == 0)
    return (int32_t) a;
  else
...
int64_t sx_int32_int64 (int32_t a, int msb)
{
  if (msb == 0)
    return (int64_t) a;
  else
...
/* i64to? */
int64_t sx_int64_int64 (int64_t a, int msb)
{
  if (msb == 0)
    return (int64_t) a;
  else
...
int main ()
{
  ...
  for (i = 0; i < 8; i ++)
    {
      assert (c == int8_sx[i][0]);
      assert (int8_sx[i][0] | int8_sx[i][1] == int8_sx[i][1]);
  ...
  for (i = 0; i < 16; i ++)
    {
      assert (i16 == int16_sx[i][0]);
      assert (int16_sx[i][0] | int16_sx[i][1] == int16_sx[i][1]);
  ...
  for (i = 0; i < 32; i ++)
    {
      assert (i32 == int32_sx[i][0]);
      assert (int32_sx[i][0] | int32_sx[i][1] == int32_sx[i][1]);
  ...
  for (i = 0; i < 64; i ++)
    {
      assert (i64 == int64_sx[i][0]);
      assert (int64_sx[i][0] | int64_sx[i][1] == int64_sx[i][1]);
