...
and pp_print_name_or_mem_list fm name_or_mem_list = 
  Mlite_printer.pp_print_list fm
    pp_print_name_or_mem
    (fun fm -> pp_print_string fm ","; pp_print_space fm ())
    name_or_mem_list
    
and pp_print_name_or_mem fm = function
  | NameOrMemAt (name_or_mem, region) ->
      begin
	pp_print_region fm region;
	pp_print_name_or_mem fm name_or_mem
      end
	
  | Name (hint_opt, name, aligned_opt) ->
      begin
...
and pp_print_stmt fm = function
  ...
  | AssignStmt (name_or_mem_list, guarded_list) ->
      begin
	pp_open_box fm 0;
	pp_print_name_or_mem_list fm name_or_mem_list;
	pp_print_string fm " = ";
	Mlite_printer.pp_print_list fm 
	  pp_print_guarded
	  (fun fm -> pp_print_string fm ","; pp_print_space fm ())
  ...
  | CallStmt (name_or_mem_list, conv_opt, expr, 
  ...
  | PrimStmt (name_or_mem_list, conv_opt, name, actual_list, flow_list) -> 
      begin
	pp_open_box fm 0;
	Mlite_printer.pp_print_list fm
	  pp_print_name_or_mem 
